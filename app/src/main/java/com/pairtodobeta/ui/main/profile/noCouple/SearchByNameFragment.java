        ...
        btnConfirmSendCouple.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DataService.init().searchPairByNameOrEmail(new DataService.onSearchUser() {
                    @Override
                    public void onSearchUserResult(List<User> users) {
            ...
            }, PrefRepository.getToken(getActivity()), inputQuery.getText().toString().trim(), "nic_name_or_email");
            }
        });
