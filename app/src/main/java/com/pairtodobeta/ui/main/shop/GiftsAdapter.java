...
public class GiftsAdapter extends RecyclerView.Adapter<GiftsAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_gift, viewGroup, false);
        return new ViewHolder(view, viewGroup.getContext());
    }

    @Override
    public void onBindViewHolder(final ViewHolder viewHolder, int i) {
        Picasso.with(context).load(storageGiftList.get(i).getPreview()).into(viewHolder.giftImage,
        ...
        else viewHolder.giftName.setText(storageGiftList.get(i).getNameRu());
    }
