...
import com.pairtodobeta.data.entities.shop.Theme;
...
public class ThemesAdapter extends RecyclerView.Adapter<ThemesAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, int i) {
        ...
        else viewHolder.themeName.setText(themeList.get(i).getNameRu());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if (v == container) {
                ...
                Toast.makeText(context, "Закройте и откройте приложение, чтобы применить тему!", Toast.LENGTH_SHORT).show();
            }
        }
