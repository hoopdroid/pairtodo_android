package com.pairtodobeta.ui.main.tasks.task;
...
public class TaskActivity extends BaseActivity {
    ...
    RelativeTimeTextView mDueDate;
    @Bind(R.id.executorImage)
    ImageView mExecutorImage;
    @Bind(R.id.fab)
    FloatingActionButton mMarkTaskBtn;
    @Bind(R.id.jobChatBtn)
    Button mJobChatBtn;
    ...
    private void initViewElements() {
        ...
        if (!mTask.getImage().equals("")) {
            ...
            mTaskImage.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    ActivityRouter.startPhotoActivity(TaskActivity.this,
                            mTask.getImage(), mTaskImage, Constants.IMAGE_TRANSITION);
                }
            });
        }
