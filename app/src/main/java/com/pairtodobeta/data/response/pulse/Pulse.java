package com.pairtodobeta.data.response.pulse;
...
public abstract class Pulse {
    ...
    @SerializedName("job_message")
    public abstract String jobMessage();
    ...
    @SerializedName("pair_last_visit")
    public abstract String pairLastVisit();
    ...
    @SerializedName("pair_add")
    public abstract String pairAdd();
