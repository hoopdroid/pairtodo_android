package com.pairtodobeta.data.response.stats;
...
public class Me {
    ...
    @SerializedName("add_job")
    @Expose
    private String addJob;
    @SerializedName("del_job")
    @Expose
    private String delJob;
    @SerializedName("assign_job")
    @Expose
    private String assignJob;
    @SerializedName("obtained_job")
    @Expose
    private String obtainedJob;
    @SerializedName("delay_job")
    @Expose
    private String delayJob;
    @SerializedName("during_job")
    @Expose
    private String duringJob;
    @SerializedName("executed_job")
    @Expose
    private String executedJob;
    @SerializedName("renew_job")
    @Expose
    private String renewJob;
