...
public class SignInApiService {
    ...
    public void signUpUser(final onSignUpResult listener, String name, String email, String password) {
        ...
        ApiManager.getApiService().signUpUser(SignConfig.APP_ID, SignConfig.generateSig(args), SignConfig.APP_LANG,
                SignConfig.OS, email, name, SignConfig.generateSHA1(password), timeStamp).enqueue(new Callback<BasicResponse>() {
            @Override
    ...
    public void signInUser(final onSignUpResult listener, String email, String password) {
        ...
        ApiManager.getApiService().signInUser(SignConfig.APP_ID, SignConfig.generateSig(args),
                SignConfig.APP_LANG, SignConfig.OS, email, SignConfig.generateSHA1(password), timeStamp
    ...
    public void signInSocial(final onSignUpResult listener, String socialName, String id, String photo,
                             String name) {
        ArrayList<String> args = new ArrayList<>();
        args.add(socialName);
        ...
        ApiManager.getApiService().signInUserVk(SignConfig.APP_ID, SignConfig.generateSig(args),
                SignConfig.APP_LANG, SignConfig.OS, socialName, SignConfig.generateSHA1(id), name, photo ,timeStamp).enqueue(new Callback<BasicResponse>() {
            @Override
            public void onResponse(Call<BasicResponse> call, Response<BasicResponse> response) {
                listener.onSignUpResult(response.body());
            }
