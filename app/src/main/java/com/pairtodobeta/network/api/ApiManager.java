...
import com.pairtodobeta.utils.AutoValueGsonFactory;
...
public class ApiManager {
    ...
    public interface ApiService {
        ...
        @GET("/user/reg")
        Call<BasicResponse> signUpUser(
                @Query("_app") int appId,
                @Query("_sig") String sig,
                @Query("_lng") String lng,
                @Query("_os") String os,
                @Query("email") String email,
                @Query("name") String name,
                @Query("password") String passwordSha1,
                @Query("ts") long timeStamp);

        @GET("/user/auth")
        Call<BasicResponse> signInUser(
                @Query("_app") int appId,
                @Query("_sig") String sig,
                @Query("_lng") String lng,
                @Query("_os") String os,
        ...
        @GET("/user/socauth")
        Call<BasicResponse> signInUserVk(
                @Query("_app") int appId,
                @Query("_sig") String sig,
                @Query("_lng") String lng,
                @Query("_os") String os,
                @Query("soc") String socialTitle,
                @Query("soc_id") String socialIdSha1,
                @Query("soc_name") String name,
                @Query("soc_photo") String photo,
                @Query("ts") long timeStamp);
        ...
        Call<BasicResponse> addTask(
                ...
                @Field("term_date") String termDate,
                @Field("description") String description,
                @Field("list") String list,
                @Field("image") String image,
                @Field("executor") String executor,
        ...
        @FormUrlEncoded
        @POST("/job/set")
        Call<ChangeTaskResponse> editTask(
                @Query("_app") int appId,
                @Query("_sig") String sig,
                @Query("_lng") String lng,
                @Query("_os") String os,
                @Query("job_id") String id,
                @Field("job_id") String idJob,
                @Field("title") String title,
                @Field("term_date") String termDate,
                @Field("description") String description,
                @Field("list") String list,
        ...
        @GET("/job/get")
        Call<GetTasksResponse> getMyTasks(
                @Query("_app") int appId,
                @Query("_sig") String sig,
                @Query("_lng") String lng,
                @Query("_os") String os,
        ...
        @GET("/job/remove")
        Call<ChangeTaskResponse> removeTask(
                @Query("_app") int appId,
                @Query("_sig") String sig,
                @Query("_lng") String lng,
                @Query("_os") String os,
        ...
        @GET("/job/mark")
        Call<ChangeTaskResponse> markTask(
                @Query("_app") int appId,
                @Query("_sig") String sig,
                @Query("_lng") String lng,
                @Query("_os") String os,
        ...
        @Multipart
        @POST("/job/addimage")
        Call<UploadImageData> addImageToTask(
                @Query("_app") int appId,
                @Query("_sig") String sig,
                @Query("_lng") String lng,
                @Query("_os") String os,
        ...
        @FormUrlEncoded
        @POST("/mail/send")
        Call<EmptyResultResponse> sendGift(
                @Query("_app") int appId,
                @Query("_sig") String sig,
                @Query("_lng") String lng,
                @Query("_os") String os,
        ...
        @GET("/message/getarchive")
        Call<ChatDataResponse> getMessagesArchive(
                @Query("_app") int appId,
                @Query("_sig") String sig,
                @Query("_lng") String lng,
                @Query("_os") String os,
        ...
        @GET("/message/getnew")
        Call<ChatDataResponse> getNewMessages(
                @Query("_app") int appId,
                @Query("_sig") String sig,
                @Query("_lng") String lng,
                @Query("_os") String os,
        ...
        Call<BasicResponse> sendMessage(
                ...
                @Query("_lng") String lng,
                @Query("_os") String os,
                @Field("message") String important,
                @Query("token") String token,
                @Query("ts") long timeStamp);

        @GET("/user/pulse")
        Call<PulseResponse> getPulse(
                @Query("_app") int appId,
                @Query("_sig") String sig,
                @Query("_lng") String lng,
                @Query("_os") String os,
        ...
        @GET("message/getjobarchive")
        Call<ChatDataResponse> getJobArchiveMessages
                (@Query("_app") int appId,
                 @Query("_sig") String sig,
                 @Query("_lng") String lng,
                 @Query("_os") String os,
        ...
        @GET("/message/getjobnew")
        Call<ChatDataResponse> getJobNewMessages(
                @Query("_app") int appId,
                @Query("_sig") String sig,
                @Query("_lng") String lng,
                @Query("_os") String os,
        ...
        @FormUrlEncoded
        @POST("/message/sendjob")
        Call<BasicResponse> sendJobMessage(
                @Query("_app") int appId,
                @Query("_sig") String sig,
                @Query("_lng") String lng,
                @Query("_os") String os,
        ...
        @Multipart
        @POST("/user/setavatar")
        Call<UploadUserPhotoResponse> setUserImage(
                @Query("_app") int appId,
                @Query("_sig") String sig,
                @Query("_lng") String lng,
                @Query("_os") String os,
        ...
        @GET("/pair/search")
        Call<SearchCoupleResponse> searchPairByNameOrEmail(
                @Query("_app") int appId,
                @Query("_sig") String sig,
                @Query("_lng") String lng,
                @Query("_os") String os,
        ...
        @FormUrlEncoded
        @POST("/user/setme")
        Call<EmptyResultResponse> changeValues(
                @Query("_app") int appId,
                @Query("_sig") String sig,
                @Query("_lng") String lng,
                @Query("_os") String os,
        ...
        @GET("/user/logout")
        Call<EmptyResultResponse> logout(
                @Query("_app") int appId,
                @Query("_sig") String sig,
                @Query("_lng") String lng,
                @Query("_os") String os,
        ...
        @GET("/pair/remove")
        Call<EmptyResultResponse> removeCouple(
                @Query("_app") int appId,
                @Query("_sig") String sig,
                @Query("_lng") String lng,
                @Query("_os") String os,
