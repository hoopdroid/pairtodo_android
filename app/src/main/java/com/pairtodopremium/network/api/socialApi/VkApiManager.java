  ...
  public static void getUserInfo(final Activity activity) {
    ...
    if (VKAccessToken.currentToken() != null) {
      ...
      VKRequest vkRequest = new VKRequest("users.get",
          VKParameters.from(VKApiConst.ACCESS_TOKEN, userToken, VKApiConst.FIELDS,
              "first_name,last_name,photo_200,domain"));
      vkRequest.executeWithListener(new VKRequest.VKRequestListener() {
        ...
        @Override public void onProgress(VKRequest.VKProgressType progressType, long bytesLoaded,
            long bytesTotal) {
