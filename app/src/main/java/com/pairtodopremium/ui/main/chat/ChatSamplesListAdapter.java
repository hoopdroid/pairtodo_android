...
public class ChatSamplesListAdapter
    extends RecyclerView.Adapter<ChatSamplesListAdapter.ChatPresentationViewHolder> {
  ...
  @Override public ChatPresentationViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    View v =
        LayoutInflater.from(parent.getContext()).inflate(R.layout.item_chat_sample, parent, false);
  ...
  @Override public void onBindViewHolder(ChatPresentationViewHolder holder, int position) {
