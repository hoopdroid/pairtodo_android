...
public class SendGiftActivity extends BaseActivity {
  ...
  @Bind(R.id.giftName) EditText giftNameEdit;
  @Bind(R.id.giftImage) ImageView giftImage;
  @Bind(R.id.sendGiftBtn) Button sendGiftBtn;
      ...
      sendGiftBtn.setOnClickListener(new View.OnClickListener() {
        @Override public void onClick(View view) {
          DataService.init().sendGift(new DataService.onMessageTask() {
                                      ...
                                      }, PrefRepository.getToken(SendGiftActivity.this),
              giftNameEdit.getText().toString().trim(), sendedStorageGift.getTovarName());
        }
      });
    }
  }
