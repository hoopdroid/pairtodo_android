...
public class MessagesListAdapter<MESSAGE extends IMessage>
    ...
    * */
    ...
    public static String getStickerPath(String message){
        ...
        stringBuilder.append(message.substring(
                Constants.STICKER.length(), message.indexOf("_")));
        stringBuilder.append("/");
        stringBuilder.append("b");
        String stickerNumber = message.substring(
                message.indexOf("_")+1,message.length());
