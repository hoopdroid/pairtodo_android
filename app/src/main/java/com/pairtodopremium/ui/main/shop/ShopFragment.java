...
public class ShopFragment extends BaseFragment {
  @Bind(R.id.themes_container) ViewGroup themesContainer;
  @Bind(R.id.gifts_container) ViewGroup giftsContainer;
  @Bind(R.id.stickers_container) ViewGroup stickersContainer;

  @Bind(R.id.img_themes_image) ImageView themeImage;
  @Bind(R.id.img_gifts_image) ImageView giftsImage;
  @Bind(R.id.img_stickers_image) ImageView stickersImage;
