...
import com.pairtodopremium.data.entities.shop.StickersData;
import com.pairtodopremium.data.entities.shop.ThemesData;
...
public class ShopCategoryActivity extends BaseActivity {
  ...
  private void fillStickers() {
    ...
    com.pairtodopremium.data.entities.shop.StickersData data =
  ...
  private void fillGifts() {
    ...
    GiftsData data = gson.fromJson(JsonHelper.loadJSONFromAsset(this, "gifts"), type);
    RecyclerView.LayoutManager layoutManager = new GridLayoutManager(this, 2);
    mRecyclerView.setLayoutManager(layoutManager);

    GiftsAdapter adapter = new GiftsAdapter(this, data.getStorageGifts());
    mRecyclerView.setAdapter(adapter);
  }
}
