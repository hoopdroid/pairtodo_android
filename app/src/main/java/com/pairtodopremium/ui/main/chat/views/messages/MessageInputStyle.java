...
class MessageInputStyle extends Style {
  ...
  static MessageInputStyle parse(Context context, AttributeSet attrs) {
    ...
    style.inputButtonBackground =
        typedArray.getDrawable(R.styleable.MessageInput_inputButtonBackground);
    ...
    style.inputButtonWidth =
        typedArray.getDimensionPixelSize(R.styleable.MessageInput_inputButtonWidth,
            style.getDimension(R.dimen.input_button_width));
    style.inputButtonHeight =
    ...
    style.inputButtonMargin =
        typedArray.getDimensionPixelSize(R.styleable.MessageInput_inputButtonMargin,
            style.getDimension(R.dimen.input_button_margin));
    style.inputMaxLines =
        typedArray.getInt(R.styleable.MessageInput_inputMaxLines, DEFAULT_MAX_LINES);
