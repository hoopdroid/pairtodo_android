...
public class StatsActivity extends BaseActivity {
  @Bind(R.id.userDoneTasks) TextView userDoneTasks;
  @Bind(R.id.userExpiredTasks) TextView userExpiredTasks;
  @Bind(R.id.userNotExecuted) TextView userNotExecutedTasks;

  @Bind(R.id.pairDoneTasks) TextView pairDoneTasks;
  @Bind(R.id.pairExpiredTasks) TextView pairExpiredTasks;
  @Bind(R.id.pairNotExecuted) TextView pairNotExecutedTasks;

  @Bind(R.id.pairProfileName) TextView pairName;
  @Bind(R.id.pairProfilePhoto) CircularImageView pairPhoto;

  @Bind(R.id.userProfilePhoto) CircularImageView userPhoto;
  ...
  @Override protected void onCreate(Bundle savedInstanceState) {
    ...
    DataService.init().getStats(new DataService.onStatsResult() {
      @Override public void onStatsResult(StatsData response) {
    ...
    if (!Objects.equals(userInfo.getPhotoReal(), "")) {
      ...
      Picasso.with(this).load(SettingsRepository.getUserInfo(realm).getPhotoReal()).into(userPhoto);
    }
