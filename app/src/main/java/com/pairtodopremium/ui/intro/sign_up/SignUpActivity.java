...
public class SignUpActivity extends BaseActivity {
  ...
  @Bind(R.id.input_name) EditText inputNameEdit;
  @Bind(R.id.input_email) EditText inputEmaiEdit;
  @Bind(R.id.input_password) EditText inputPasswordEdit;
  @Bind(R.id.registrationLayout) ViewGroup registrationLayout;
  @Bind(R.id.progressBar) ProgressBar mProgressBar;
  @Bind(R.id.btn_sign_in) Button signInBtn;
  @Bind(R.id.btn_sign_up) Button signUpBtn;
  @Bind(R.id.input_layout_password) TextInputLayout inputPasswordLayout;
  @Bind(R.id.input_layout_name) TextInputLayout inputNameLayout;
  @Bind(R.id.sign_content) ViewGroup signContent;
  ...
  @Override protected void onCreate(@Nullable Bundle savedInstanceState) {
    ...
    inputPasswordEdit.setInputType(
  ...
  private void signUpRest() throws UnsupportedEncodingException {
    ...
    if (validateName() && validatePassword()) {
      ...
      SignInApiService.init().signUpUser(new SignInApiService.onSignUpResult() {
                                           @Override public void onSignUpResult(BasicResponse response) {
                                             if (response.getResult() != null) {
                                               ...
                                               Toast.makeText(SignUpActivity.this, response.getError().getMessage(),
                                           ...
                                           @Override public void onSignUpError(String message) {
                                             mProgressBar.setVisibility(View.GONE);
                                             signContent.setVisibility(View.VISIBLE);
                                             Toast.makeText(SignUpActivity.this, R.string.correct_login_password, Toast.LENGTH_SHORT)
                                                 .show();
                                           }
