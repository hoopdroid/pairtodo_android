...
public class SignInActivity extends BaseActivity {
  ...
  @Bind(R.id.input_layout_email) TextInputLayout inputEmailLayout;
  @Bind(R.id.vk_auth) ImageView vkAuth;
  @Bind(R.id.fb_auth) ImageView fbAuth;
      ...
      SignInApiService.init().signInUser(new SignInApiService.onSignUpResult() {
        @Override public void onSignUpResult(BasicResponse response) {
          if (response.getResult() != null) {
            ...
            Toast.makeText(SignInActivity.this, response.getError().getMessage(),
        ...
        @Override public void onSignUpError(String message) {
          mProgressBar.setVisibility(View.GONE);
          signContent.setVisibility(View.VISIBLE);
          Toast.makeText(SignInActivity.this, R.string.correct_login_password, Toast.LENGTH_SHORT)
              .show();
        }
      }, inputEmaiEdit.getText().toString().trim(), inputPasswordEdit.getText().toString().trim());
    } else {
      Toast.makeText(this, getString(R.string.please_enter_correct_values), Toast.LENGTH_SHORT)
          .show();
    }
  }
