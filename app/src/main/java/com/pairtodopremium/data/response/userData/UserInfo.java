...
public class UserInfo extends RealmObject {
  ...
  @SerializedName("nic_name") @Expose private String nicName;
  @SerializedName("registred") @Expose private String registred;
  @SerializedName("name") @Expose private String name;
  @SerializedName("photo") @Expose private String photo;
  @SerializedName("email") @Expose private String email;
  @SerializedName("tel") @Expose private String tel;
  @SerializedName("pair_id") @Expose private String pairId;
  @SerializedName("pair_name") @Expose private String pairName;
  @SerializedName("last_modify") @Expose private String lastModify;
  @SerializedName("photo_real") @Expose private String photoReal;
  @SerializedName("bg_thema") @Expose private String bgThema;
  @SerializedName("is_vip") @Expose private String isVip;
  @SerializedName("vip_date") @Expose private String vipDate;
  @SerializedName("pair_photo") @Expose private String pairPhoto;
