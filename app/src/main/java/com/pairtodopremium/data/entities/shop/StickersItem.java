...
public class StickersItem {
  ...
  @SerializedName("col") @Expose private int col;
  ...
  @SerializedName("sticker") @Expose private String sticker;

  @SerializedName("count") @Expose private int count;

  @SerializedName("row") @Expose private int row;

  @SerializedName("nom") @Expose private int nom;
