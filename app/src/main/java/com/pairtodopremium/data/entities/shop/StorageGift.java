...
public class StorageGift implements Parcelable {
    ...
    public static final Parcelable.Creator<StorageGift> CREATOR = new Parcelable.Creator<StorageGift>() {
        @Override
        public StorageGift createFromParcel(Parcel source) {
            return new StorageGift(source);
        }

        @Override
        public StorageGift[] newArray(int size) {
